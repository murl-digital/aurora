/**
 * This file is part of PacketWrapper. Copyright (C) 2012-2015 Kristian S. Strangeland Copyright (C)
 * 2015 dmulloy2
 * <p>
 * PacketWrapper is free software: you can redistribute it and/or modify it under the terms of the
 * GNU Lesser General Public License as published by the Free Software Foundation, either version 3
 * of the License, or (at your option) any later version.
 * <p>
 * PacketWrapper is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY;
 * without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See
 * the GNU General Public License for more details.
 * <p>
 * You should have received a copy of the GNU Lesser General Public License along with
 * PacketWrapper.  If not, see <http://www.gnu.org/licenses/>.
 */
package fyi.sorenneedscoffee.aurora.wrapper;
...
public class WrapperPlayClientSetCommandBlock extends AbstractPacket {
  ...
  public Mode getMode() {
    return handle.getEnumModifier(Mode.class,
        MinecraftReflection.getMinecraftClass("TileEntityCommand$Type")).readSafely(0);
  }

  public void setMode(Mode mode) {
    handle.getEnumModifier(Mode.class,
        MinecraftReflection.getMinecraftClass("TileEntityCommand$Type")).writeSafely(0, mode);
  }
