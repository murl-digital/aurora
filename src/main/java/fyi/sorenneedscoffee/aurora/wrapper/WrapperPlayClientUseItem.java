...
import fyi.sorenneedscoffee.aurora.wrapper.util.Removed;
...
public class WrapperPlayClientUseItem extends AbstractPacket {
  ...
  private static final Class<?> POSITION_CLASS = MinecraftReflection
      .getMinecraftClass("MovingObjectPositionBlock");
