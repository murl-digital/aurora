...
class ReferenceLaser {
    ...
    /**
     * Create a ReferenceLaser instance
     ...
     */
    public ReferenceLaser(Location start, Location end, int duration, int distance) throws ReflectiveOperationException {
        this.start = start;
        this.end = end;
